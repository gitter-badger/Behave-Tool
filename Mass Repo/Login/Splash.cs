...
using static MassRepo.Rainbow;

namespace MassRepo
{
    public partial class Splash : Form
    {   // morning
        private TimeSpan morningStart = new TimeSpan(02, 00, 00);
        private TimeSpan morningEnd = new TimeSpan(11, 59, 59);

        // afternoon
        private TimeSpan afternoonStart = new TimeSpan(13, 00, 00);

        private TimeSpan afternoonEnd = new TimeSpan(17, 59, 59);

        // evening
        private TimeSpan eveningStart = new TimeSpan(18, 00, 00);

        private TimeSpan eveningEnd = new TimeSpan(22, 59, 59);
        private TimeSpan nightStart = new TimeSpan(23, 00, 00);
        private TimeSpan nightEnd = new TimeSpan(01, 59, 59);

        public static TimeSpan now = DateTime.Now.TimeOfDay;
        private Image loading = (Image)Properties.Resources.Loading_Gif.Clone();
