using MassRepo;
using MassRepo.Tools;
using MassRepo.Tools.Network;
using MassRepo.Widget;
//using MassRepo.Widget;
using System;
...
namespace MassRepo
{
    ...
    public partial class MassRepo : Form
    {
        ...
        private void MassRepo_Load(object sender, EventArgs e)
        {
        ...
        private void Load_Settings()
        {
            ...
            Opacity = Properties.Settings.Default.MassRepoOpacity; // default 0.9;
        }
        ...
        private void Main_Resize(object sender, EventArgs e)
        {
            ...
            {
               // notifyIcon1.Icon = Properties.Resources.MassRepo_Icon;
